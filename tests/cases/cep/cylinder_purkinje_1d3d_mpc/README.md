...
# Multipoint constraint implementation plan
1. Add input file option instead of nodes
2. Find points and weights for each surface element (assemble B matrices?)
3. After equation assembly in cep, check if there's a MPC and modify RHS
